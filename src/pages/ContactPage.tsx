...
const ContactPage = () => {
  ...
  const [generalData, setGeneralData] =
    useState<GeneralFormData>(initialGeneralData);
  const {
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6">
            ...
            <AnimatedSection delay={0.1}>
              <a
                ...
                onClick={() => trackContact.telClick()}
                className="trade-card group block h-full"
              >
                <PhoneCallIcon className="w-6 h-6 text-accent mb-4" />
                <h3 className="font-serif text-lg mb-2 group-hover:text-accent transition-colors">
                  Tel:
                </h3>
                <p className="text-sm text-muted-foreground">
        ...
        <div className="container-narrow text-center">
          <AnimatedSection>
            ...
            <p className="mt-4 text-muted-foreground max-w-xl mx-auto">
              Submit a detailed sourcing enquiry and tell us about your
              requirements—origin preferences, volume expectations, profile
              targets, and timing.
            </p>
            <button
              onClick={() => {
        ...
        <div className="container-narrow">
          <AnimatedSection>
            <SectionHeader
              ...
              description="For general enquiries, introductions, or questions about working with us."
            />
          </AnimatedSection>
          <AnimatedSection delay={0.2}>
            {generalStatus === "success" ? (
              ...
              <form onSubmit={handleGeneralSubmit} className="space-y-6 mt-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleGeneralChange("company", e.target.value)
                      }
                    />
                  </div>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleGeneralChange("country", e.target.value)
                      }
                    />
                  </div>
                </div>
                <div>
                  ...
                  <Select
                    value={generalData.buyerType}
                    onValueChange={(value) =>
                      handleGeneralChange("buyerType", value)
                    }
                  >
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    onChange={(e) =>
                      handleGeneralChange("message", e.target.value)
                    }
                  />
                </div>
                <button
        ...
        <div className="container-narrow">
          <AnimatedSection>
            <SectionHeader
              ...
              description="For producers, exporters, and processors interested in working with us."
            />
            <p className="text-sm text-muted-foreground mb-6">
              Due to volume, we may not respond immediately. Suitable
              introductions will be followed up directly.
            </p>
          </AnimatedSection>
          <AnimatedSection delay={0.2}>
            {partnerStatus === "success" ? (
              <div className="p-6 border border-success text-success text-center">
                <p className="font-medium">
                  Thank you for your introduction. We'll review and follow up if
                  there's a fit.
                </p>
                <button
              ...
              <form onSubmit={handlePartnerSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handlePartnerChange("organization", e.target.value)
                      }
                    />
                  </div>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handlePartnerChange("role", e.target.value)
                      }
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handlePartnerChange("email", e.target.value)
                      }
                    />
                  </div>
                </div>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handlePartnerChange("country", e.target.value)
                    }
                  />
                </div>
                <div>
                  ...
                  <Select
                    value={partnerData.representing}
                    onValueChange={(value) =>
                      handlePartnerChange("representing", value)
                    }
                  >
                    <SelectTrigger className="mt-2">
                      <SelectValue placeholder="Select type" />
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    onChange={(e) =>
                      handlePartnerChange("description", e.target.value)
                    }
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handlePartnerChange("websiteLink", e.target.value)
                    }
                  />
                </div>
                <button
